export default {
  ...
  testPathIgnorePatterns: ["/node_modules/", "<rootDir>/client/", "<rootDir>/tests/e2e/", "<rootDir>/tests/security/", "<rootDir>/tests/loadtest/", "<rootDir>/tests/spike/", "<rootDir>/tests/soak/"],
